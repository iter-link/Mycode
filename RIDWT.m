function [ C,Sg,flag] = RIDWT(image1)
%图像的重新分布不变小波正变换(Redistribute invariant wavelet transform)
...
%%%%对RI做一级haar小波分解，并将得到的结果与符号阵相乘得到B，按照一定的规则对B进行操作，得到不变小波域C
[cA1,cH1,cV1,cD1]=dwt2(RI,'haar');
B=zeros(m,n);
